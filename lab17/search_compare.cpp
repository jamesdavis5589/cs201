...
int main() {
	while (true) {
		...
		//creates vector and fills it with random int values, also creates vector filled with numbered entries
		vector <int> v1;
		vector <int> v2;
		...
		sequentialSearch(v1, v2, ki, setKi);
